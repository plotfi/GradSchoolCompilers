...
time -p -o blocksized_ap_seq_`echo $size`_`echo $accesses`_1_0_pin.time \
         ../../../intel64/bin/pinbin -t obj-intel64/tracer.so -benchname blocksized_ap_seq_`echo $size`_`echo $accesses` -- ./microbenchmarks/blocksized_ap.exe seq $size $accesses 1 0
