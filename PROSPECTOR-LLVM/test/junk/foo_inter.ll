; ModuleID = '../TestProrgrams/foo_inter.bc'
...
define void @OnLoopStart(i8* %loop, i8* %str) nounwind {
entry:
...
define void @OnLoopIterate(i8* %loop, i8* %str) nounwind {
entry:
  %loop_addr = alloca i8*                         ; <i8**> [#uses=2]
  %str_addr = alloca i8*                          ; <i8**> [#uses=1]
...
define void @OnLoopExit(i8* %loop, i8* %str) nounwind {
entry:
  %loop_addr = alloca i8*                         ; <i8**> [#uses=2]
  %str_addr = alloca i8*                          ; <i8**> [#uses=1]
  %currStackSize = alloca i32                     ; <i32*> [#uses=3]
...
define void @PushLoopStack(i8* %loopname, i8* %parent) nounwind {
entry:
